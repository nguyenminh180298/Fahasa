...
public class Database {
    ...
    public Database(){
        try {
            String sUrl= "jdbc:mysql://localhost/fahasa?useUnicode=true&characterEncoding=UTF-8&Timezone=true&serverTimezone=UTC&allowMultiQueries=true"; // chuỗi kết nối database url localhost
